...
<!-- /Footer Section -->
<div class="clearfix"></div>
<div class="linha-acima-footer">
	<div class="container">
		<div class="row">
			<div class="col-md-4 bloco width300">
                		<div id="simbolo">
                    <img src="http://estacionamentopatioconfins.com.br\/img\/arco.png" alt="pconf">
                    <h4>Pátio Confins</h4>
                    <div class="custom58">
                    Rua Lapa Vermelha, 180 - Confins<br>
                    Utilize "Rua Lapa Vermelha", sem numeração, no seu GPS.<br>
                    patioconfins@estacionamentopatioconfins.com.br</div>
                		</div>
            		</div>

			<div class="col-md-4 bloco width300">	
					<?php the_widget('WeblizarFacebook', 'FacebookPageURL=https://www.facebook.com/PatioConfins/&Height=342'); ?> 
            		</div>     
...
<!--/Scroll To Top--> 
<?php wp_footer();
 require('datetimepicker_setup.php'); ?>
</body>
</html>
